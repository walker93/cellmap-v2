...
## Corpus Check
- 64 files · ~189,591 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 526 nodes · 1216 edges · 24 communities (17 shown, 7 thin omitted)
- Extraction: 90% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88259a52`
...
- `styleimagemissing Hook for Icon Registration` --rationale_for--> `registerMapEvents()`  [INFERRED]
  MODERNIZATION.md → src/mapEvents.js
...
Cohesion: 0.12
Nodes (33): Legacy Sidebar UI (flat button row, 'Elementi:' list), Project Menu (save/open/import/export), Phase 3 - Convert to ES Modules, styleimagemissing Hook for Icon Registration, CSV Tower Import Feature, KML Generation Feature, addCellLayer(), addMeasurementTools() (+25 more)

### Community 1 - "towerState.js"
Cohesion: 0.13
Nodes (32): Duplicating a Tower Silently Lost Its Coverage Sector, Hidden-POI List Desync on Delete All / Delete While Hidden, Implicit Undocumented Data Model (three-collection sync), Phase 4 - Formalize the State Model, properties.id Must Match Draw Feature id (show/hide filter), towerid String Linkage Between Draw and Sectors, buildRingCollection(), addHiddenPoi() (+24 more)

### Community 2 - "project.js"
Cohesion: 0.10
Nodes (31): .cellmap Project File Format, Map Display Settings Panel (ring spacing/opacity/labels), Sector Options: Uncertainty Cone + Distance Rings Toggles, File System Access API for Exports (showSaveFilePicker), buildRings(), DEFAULT_RING_INTERVAL, DEFAULT_RING_STROKE_OPACITY, defaultRingInterval() (+23 more)

### Community 3 - "form.js"
Cohesion: 0.09
Nodes (31): Mixed Italian/English UI Strings ('Ricerca', 'Elementi:'), Draw Measurement Label (4.8km line between points), Add/Edit Cell Dialog (#inputs), Dialog Focus Trap (Tab/Shift+Tab containment), escapeHtml(), registerMapEvents(), cache, clearElementCache() (+23 more)
...
Cohesion: 0.20
Nodes (22): attr(), data(), description(), documentDescription(), documentName(), encode(), extendeddata(), feature() (+14 more)

### Community 9 - "papaparse.min.js"
Cohesion: 0.20
Nodes (20): CDN Script Tags (Mapbox, Draw, Geocoder, TomSelect, JSZip), Mapbox CDN Unreachable in CI - Live Map Untestable, c(), e(), g(), h(), l(), m() (+12 more)
...
### Community 17 - "kmz.js"
Cohesion: 0.08
Nodes (14): addRasterOverlay(), DEFAULT_OVERLAY_OPACITY, escapeXml(), importKMZ(), importKmzFile(), nextOverlayId(), overlayToKmz(), parseLatLonBox() (+6 more)
...
- **Why does `CDN Script Tags (Mapbox, Draw, Geocoder, TomSelect, JSZip)` connect `papaparse.min.js` to `tokml.js`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `CI Pipeline (lint + test on every branch)` connect `scripts` to `papaparse.min.js`?**
